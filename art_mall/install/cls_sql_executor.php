...
class sql_executor
{
     ...
     * @return  void
     */
    function __construct($db, $charset = 'utf8', $sprefix = 'oun_', $tprefix = 'oun_', $log_path = '', $auto_match = false, $ignored_errors = array())
    {
     ...
     * @return  void
     */
    function sql_executor($db, $charset = 'utf8', $sprefix = 'oun_', $tprefix = 'oun_', $log_path = '', $auto_match = false, $ignored_errors = array())
    {
        $this->db = $db;
