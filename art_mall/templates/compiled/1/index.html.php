...
var swfurl = "<?php echo $this->_var['template_path']; ?>images/player.swf";
var pic_width=687; //图片宽度
var pic_height=266; //图片高度
var imag=new Array();
var link=new Array();
var text=new Array();
imag[1]="<?php echo $this->_var['template_path']; ?>images/flash.jpg";
link[1]=escape("#");
text[1]="pic1";
imag[2]="<?php echo $this->_var['template_path']; ?>images/flash.jpg";
link[2]=escape("#");
text[2]="pic2";
imag[3]="<?php echo $this->_var['template_path']; ?>images/flash.jpg";
link[3]=escape("#");
text[3]="pic3";
//可编辑内容结束
...
document.write('</object>');
    ...
    <div class="logindiv">
      <div>	<?php if ($this->_var['user']['user_id'] > 0): ?>  
	  <div style="padding:13px; height:15px;">
	<span style="width:80px; float:left; text-align:right"><A HREF="user.php" style="color:#FFF;margin: 10px"><?php echo $this->_var['user']['user_name']; ?></A> </span  style="float:left" ><span style="width:10px;color:#FFF; float:left">|</span><span style="width:60px; float:left;color:#FFF;" > <A HREF="user.php?o=o" style="color:#FFF;margin: 10px">logout</A></span></li>
	</div>
	<?php else: ?> 
	<img src="<?php echo $this->_var['template_path']; ?>images/register.jpg" width="193" height="39" border="0" usemap="#Map" />
    <map name="Map" id="Map"><area shape="rect" coords="4,4,85,34" href="user.php?o=r" />
<area shape="rect" coords="98,5,182,34" href="user.php" />
</map>
<?php endif; ?>
<img src="<?php echo $this->_var['template_path']; ?>images/carthead.jpg" />
</div>
	<div class="cartlist">
	<?php if ($this->_var['user']['user_id'] > 0): ?>  
	<?php echo $this->fetch('lib/users_indexcart.html'); ?> 
	<?php else: ?> 
	Your shopping cart is emmty.
	<?php endif; ?>
	</div>
	<div class="searchdiv">
...
<div id="container">
						 ...
						 <?php $_from = $this->_var['home']['Tproducts']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'products');if (count($_from)):
