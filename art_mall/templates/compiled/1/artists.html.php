  ...
  <div class="mainbody">
    ...
    <div class="maincontent">
 	  ...
 	  <div class="nr"> 
 			...
 			<ul>
			<?php $_from = $this->_var['home']['brands']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'brands');if (count($_from)):
    foreach ($_from AS $this->_var['brands']):
?>
				<li style="float:left; width:125px;margin:10px;">
					<div>
						<a href="<?php echo $this->_var['brands']['site_url']; ?>"><IMG SRC="<?php echo $this->_var['brands']['brand_logo']; ?>" BORDER="0" title="<?php echo $this->_var['brands']['brand_name']; ?>(<?php echo $this->_var['brands']['count']; ?>)" width="125" height="90"></a>
					</div>
					<p  class="pdp">
					<a href="<?php echo $this->_var['brands']['brand_url']; ?>"><?php echo $this->_var['brands']['brand_name']; ?></a> 
					</p>
				</li>
	 ...
	 <?php if ($this->_var['home']['showpage']): ?>
	  <DIV id=page><div class="fenye" ><?php echo $this->_var['home']['showpage']; ?></div> </div> 
	<?php endif; ?>
	 </div>
  </div>
