...
if (!$smarty->is_cached($Aconf["displayFile"], $cache_id)) {
	...
	$rowproduct = $oPub->getRow("SELECT a.prid,a.pcid,a.pacid,a.prbid,a.name,a.edit_comm,a.praids,a.shop_sn,a.shop_price,a.shop_number,a.s_discount,a.s_dis_exp,a.dateadd,a.up_date,a.comms,a.hots,a.shop_thumb,a.states,b.descs,b.cltion,b.cltion_product,b.cltion_topic,b.file_exp FROM ".$pre."product as b,".$pre."producttxt as a
