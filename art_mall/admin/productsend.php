...
$Strprobrandopt .= '<OPTION VALUE="0" >艺术家artist</OPTION>';
$n = 0;
if($AnormAll)
...
<TABLE width="800" border=0>
  <TR>
    <TD align=left>
	   <p><span style="float: right"> <a href="productlist.php"> [作品列表art list]</a></span>
	     <input type="hidden" name="MAX_FILE_SIZE" value="2097152" />
	     <b>名称name：<span style="color: #FF0000">*</span></b>
	     <input type="text" size="16" name="name" value="<?php echo ($work["prid"] > 0)?$work["name"]:'';?>"   title="必填"/>
	     <b>英文名english name：<span style="color: #FF0000">*</span></b>
	      <input type="text" size="16" name="enname" value="<?php echo ($work["prid"] > 0)?$work["enname"]:'';?>"   title="必填"/>		 
	      <b><br />
	      <br />
         作品编号NO：</b>
	      ...
	      <br/>
	      <b>
      尺寸size(英寸inch</b><b>）:宽width
        <input type="text" name="cnwidth"  size="2" value="<?php echo $work[cnwidth];?>" />
        inch, 高height
        <input type="text" name="cnheight"  size="2" value="<?php echo $work[cnheight];?>"/>
        inch
        </b>
         ...
         <br />
         尺寸size(厘米cm):宽width
         <input type="text" name="enwidth"  size="2" value="<?php echo $work[enwidth];?>" />
         cm, 高height
         <input type="text" name="enheight"  size="2" value="<?php echo $work[enheight];?>"/>
         cm         </b>
         <br />
         <br/>
         <b>市场价price：</b>
...
/*		 $Strcolorsopt = '<b>名称颜色：</b>';
  ...
  <TR class=bg1>
	...
	<B>作品简述abstract：<br />
     ...
     <TEXTAREA NAME="edit_comm" ROWS="3" COLS="60"><?php echo ($work["prid"] > 0)?$work["edit_comm"]:'';?></TEXTAREA>
    </TD> 
  </TR>
  <TR class=bg1>
    <TD align=left>
	<B>更多信息additional information：</B>
 ...
 <tr>
   <td>
     <b>作品图pic：</b>		 
		 ...
		 <!--缩图尺寸pic size :宽width
		 <input type="text" name="img_width"  size="2" value="<?php echo $Aconf[big_thumb_w];?>" />
		 px 
		 高heigh
		 <input type="text" name="img_height"  size="2" value="<?php echo $Aconf[big_thumb_h];?>"/>
		 px 
...
<!--  <TR class=even>
  ...
  <TR class=bg1>
    <TD align=left>
       <input type="reset" value="重置reset" style="background-color: #FFCC66;margin-left: 300px"/>
	   <input type="submit" value="<?php echo ($work["prid"] > 0)?'修改edit':'提交add';?>" style="background-color: #FFCC66;margin-left: 100px"/>
